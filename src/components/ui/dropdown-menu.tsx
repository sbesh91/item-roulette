  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          'animate-content-hide bg-popover/50 text-popover-foreground data-[expanded]:animate-content-show z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border p-1 shadow-md backdrop-blur-sm',
          props.class
        )}
        {...rest}
      />
...
const DropdownMenuSubContent = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      class={cn(
        'bg-popover text-popover-foreground z-50 min-w-32 origin-[var(--kb-menu-content-transform-origin)] overflow-hidden rounded-md border p-1 shadow-md animate-in',
        props.class
      )}
      {...rest}
    />
